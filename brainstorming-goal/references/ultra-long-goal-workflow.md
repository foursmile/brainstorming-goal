...
- Use deterministic comparison for expensive evidence: fixed input identity, revision/configuration, seed/time controls, process state, command, timestamp, output path, and invalidation condition.
